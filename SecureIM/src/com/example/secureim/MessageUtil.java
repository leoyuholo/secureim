...
public class MessageUtil{
	...
	public static String getReceiverListString(String[] list, String userName){
		
		String[] listClone = list.clone();
		
		Arrays.sort(listClone);
		
		StringBuffer stringBuffer = new StringBuffer();
		for(String element:listClone){
	...
	public static class Chat{
		...
		public LinkedList<String> receiverList;
		...
		public Chat(Message message, String userName){

			receiverList = new LinkedList<String>();
			messageList = new LinkedList<Message>();
			
			if(!message.sender.equals(userName)){
				receiverList.add(message.sender);
			}
		...
		public Chat(LinkedList<String> receivers){

			receiverList = new LinkedList<String>(receivers);
			messageList = new LinkedList<Message>();
			
		}
		
		public Chat addReceiver(String userName){
			
			Chat chat = new Chat(receiverList);
			chat.receiverList.add(userName);
		...
		public ArrayList<String> getMessageArrayList(){
			...
			ArrayList<String> stringArrayList = new ArrayList<String>(messageList.size());
			
			String messageEntryString;
			
			for(Message element:messageList){
				
				messageEntryString = element.sender + ":\n" + element.content;
				stringArrayList.add(messageEntryString);
	...
	public static class Message{
		...
		public String getChatReceiverListString(String userName){
	...
	public static String bytesToHexString(byte[] bytes){
		...
		for (int i = 0; i < bytes.length; i++){
			...
			/*if(i > 4 && i < (bytes.length - 4)){
				
				continue;
				
			}

			if(i == 3 || i == 4 || i == (bytes.length - 3) || i == (bytes.length - 4)){
...
Log.i("Encrypt", "send: " + bytesToHexString(content));
...
Log.i("Encrypt", "receive: " + bytesToHexString(receivedData));
